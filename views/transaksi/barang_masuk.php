            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php 
                        $n=1;
                        $query = mysqli_query($con,"SELECT x.*,x1.nama_barang,x2.nama_penulis,x3.nama_kategori FROM barang_masuk x JOIN barang x1 ON x1.idbarang=x.barang_id JOIN penulis x2 ON x2.idpenulis=x1.penulis_id JOIN kategori x3 ON x3.idkategori=x1.kategori_id ORDER BY x.idbarang_masuk DESC")or die(mysqli_error($con));
                        ...
                        <tr>
                            ...
                            <td><?= $row['jumlah']; ?></td>
							<td>
                                <a href="<?=base_url();?>/process/barang_masuk.php?act=<?=encrypt('delete');?>&id=<?=encrypt($row['idbarang_masuk']);?>"
